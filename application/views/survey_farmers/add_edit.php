        ...
        <div class="row show-grid">
            <div class="col-xs-12">
                ...
                <table class="table table-bordered table-responsive-sm ">
                    <tbody>
                    <tr>
                        <th style="width: 30%"><?php echo $CI->lang->line('SURVEY_FARMER_TITLE_FARMER_NAME');?> <strong class="text-danger">*</strong></th>
                    ...
                    <tr>
                        <th><?php echo $CI->lang->line('SURVEY_FARMER_TITLE_FATHER_HUSBAND_NAME');?> <strong class="text-danger">*</strong></th>
                    ...
                    <tr>
                        <th colspan="2"><?php echo $CI->lang->line('SURVEY_FARMER_TITLE_ADDRESS');?></th>
                    </tr>
                    <tr>
                        <th colspan="2">
                            <div class="form-row">
                                <div class="col-md-3">
                                    <label for="validationTooltip01"><?php echo $CI->lang->line('SURVEY_FARMER_DISTRICT_NAME');?></label>
                                ...
                                <div class="col-md-3">
                                    <label for="validationTooltip02"><?php echo $CI->lang->line('SURVEY_FARMER_UPAZILLA_NAME');?></label>
                                ...
                                <div class="col-md-3">
                                    <label for="validationTooltip02"><?php echo $CI->lang->line('SURVEY_FARMER_UNION_NAME');?></label>
                                ...
                                <div class="col-md-3">
                                    <label for="validationTooltip02"><?php echo $CI->lang->line('SURVEY_FARMER_VILLAGE_NAME');?></label>
                                ...
                                <div class="col-md-3">
                                    <label for="validationTooltip02"><?php echo $CI->lang->line('SURVEY_FARMER_MOBILE_NO');?> <strong class="text-danger">*</strong></label>
                                    <input type="text" class="form-control" id="mobile_no" name="item[mobile_no]" value="<?php echo $item['mobile_no'];?>" />
                                </div>
                                <div class="col-md-3">
                                    <label for="validationTooltip02"><?php echo $CI->lang->line('SURVEY_FARMER_NID_NO');?></label>
                                    <input type="text" class="form-control" id="nid_no" name="item[nid_no]" value="<?php echo $item['nid_no'];?>" />
                                </div>
                                <div class="col-md-3">
                                    <label for="validationTooltip02"><?php echo $CI->lang->line('SURVEY_FARMER_GROWING_AREA');?></label>
                    ...
                    <tr>
                        ...
                        <th>
                            <div class="col-md-3">
                                <label for="validationTooltip02"><?php echo $CI->lang->line('SURVEY_FARMER_FAMILY_MEMBER_FEMALE');?></label>
                            ...
                            <div class="col-md-3">
                                <label for="validationTooltip02"><?php echo $CI->lang->line('SURVEY_FARMER_FAMILY_MEMBER_MALE');?></label>
                            ...
                            <div class="col-md-3">
                                <label for="validationTooltip02"><?php echo $CI->lang->line('SURVEY_FARMER_FAMILY_MEMBER_OTHERS');?></label>
                            ...
                            <div class="col-md-3">
                                <label for="validationTooltip02"><?php echo $CI->lang->line('SURVEY_FARMER_FAMILY_MEMBER_TOTAL');?></label>
                    ...
                    <tr>
                        ...
                        <th>
                            <div class="col-md-3">
                                <label for="land_size_cultivable"><?php echo $CI->lang->line('SURVEY_FARMER_LAND_SIZE_CULTIVABLE');?></label>
                            ...
                            <div class="col-md-3">
                                <label for="land_size_residential"><?php echo $CI->lang->line('SURVEY_FARMER_LAND_SIZE_RESIDENTIAL');?></label>
                            ...
                            <div class="col-md-3">
                                <label for="land_size_others"><?php echo $CI->lang->line('SURVEY_FARMER_OTHERS');?></label>
                            ...
                            <div class="col-md-3">
                                <label for="land_size_others_remarks" class="text-danger"><?php echo $CI->lang->line('SURVEY_FARMER_OTHERS_PLACEHOLDER');?></label>
                    ...
                    <tr>
                        ...
                        <th>
                            <div class="col-md-3">
                                <label for="cultivated_area_vegetables"><?php echo $CI->lang->line('SURVEY_FARMER_CULTIVATED_AREA_VEGETABLES');?></label>
                            ...
                            <div class="col-md-3">
                                <label for="cultivated_area_others"><?php echo $CI->lang->line('SURVEY_FARMER_OTHERS');?></label>
                    ...
                    <tr>
                        ...
                        <th>
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="last_year_cultivated_paddy"><?php echo $CI->lang->line('SURVEY_FARMER_LAST_YEAR_CULTIVATED_PADDY')?></label>
                            </div>
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="last_year_cultivated_jute"><?php echo $CI->lang->line('SURVEY_FARMER_LAST_YEAR_CULTIVATED_JUTE')?></label>
                            </div>
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="last_year_cultivated_wheat"><?php echo $CI->lang->line('SURVEY_FARMER_LAST_YEAR_CULTIVATED_WHEAT')?></label>
                            </div>
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="last_year_cultivated_mustard"><?php echo $CI->lang->line('SURVEY_FARMER_LAST_YEAR_CULTIVATED_MUSTARD')?></label>
                            </div>
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="last_year_cultivated_maize"><?php echo $CI->lang->line('SURVEY_FARMER_LAST_YEAR_CULTIVATED_MAIZE')?></label>
                            </div>
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="last_year_cultivated_others">
                                    ...
                                    <input type="text" class=" form-inline" id="last_year_cultivated_others_remarks" name="item[last_year_cultivated_others_remarks]" value="<?php echo $item['last_year_cultivated_others_remarks']?>" placeholder="<?php echo $CI->lang->line('SURVEY_FARMER_OTHERS_PLACEHOLDER')?>"  style="width: 250px;"/>
                                </label>
                            </div>
                        </th>
                    </tr>
                    <tr>
                        ...
                        <th>
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="cropping_intensity_single"><?php echo $CI->lang->line('SURVEY_FARMER_CROPPING_INTENSITY_SINGLE');?></label>
                            </div>
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="cropping_intensity_double"><?php echo $CI->lang->line('SURVEY_FARMER_CROPPING_INTENSITY_DOUBLE');?></label>
                            </div>
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="cropping_intensity_triple"><?php echo $CI->lang->line('SURVEY_FARMER_CROPPING_INTENSITY_TRIPLE');?></label>
                            </div>
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="cropping_intensity_multiple"><?php echo $CI->lang->line('SURVEY_FARMER_CROPPING_INTENSITY_MULTIPLE');?></label>
                            </div>
                        </th>
                    </tr>
                    <tr>
                        <th colspan="2"><?php echo $CI->lang->line('SURVEY_FARMER_TITLE_LAST_YEAR_VEGETABLES_CULTIVATION');?></th>
                    </tr>
                    </tbody>
                </table>
                <div class="col-md-12 col-xs-12" style=" overflow: scroll" id="system_add_more_table_container">
                    <table class="table table-bordered table-responsive" style="">
                        <thead>
                        <tr>
                            <th class="text-center" rowspan="2"><?php echo $CI->lang->line('SURVEY_FARMER_TITLE_LAST_YEAR_VEGETABLES_VARIETY_NAME');?></th>
                            <th class="text-center" rowspan="2"><?php echo $CI->lang->line('SURVEY_FARMER_TITLE_LAST_YEAR_VEGETABLES_AREA_SIZE');?></th>
                            <th class="text-center" rowspan="2"><?php echo $CI->lang->line('SURVEY_FARMER_TITLE_LAST_YEAR_VEGETABLES_PRODUCTION_TOTAL_KG');?></th>
                            <th class="text-center" rowspan="2"><?php echo $CI->lang->line('SURVEY_FARMER_TITLE_LAST_YEAR_VEGETABLES_COST_TOTAL_PRODUCED');?></th>
                            <th class="text-center" colspan="6"> <?php echo $CI->lang->line('SURVEY_FARMER_TITLE_LAST_YEAR_VEGETABLES_PRODUCTION_COST');?></th>
                            <th class="text-center" rowspan="2"><?php echo $CI->lang->line('SURVEY_FARMER_TITLE_LAST_YEAR_VEGETABLES_COST_TOTAL');?> </th>
                            <th class="text-center" rowspan="2"> <?php echo $CI->lang->line('SURVEY_FARMER_TITLE_LAST_YEAR_VEGETABLES_NET_PROFIT');?></th>
                            <th class="text-center" rowspan="2"> <?php echo $CI->lang->line('SURVEY_FARMER_TITLE_LAST_YEAR_VEGETABLES_STATUS');?></th>
                        </tr>
                        <tr>
                            <th class="text-center"><?php echo $CI->lang->line('SURVEY_FARMER_TITLE_LAST_YEAR_VEGETABLES_PRODUCTION_COST_LAND_PREPARATION');?></th>
                            <th class="text-center"><?php echo $CI->lang->line('SURVEY_FARMER_TITLE_LAST_YEAR_VEGETABLES_PRODUCTION_COST_WAGES');?></th>
                            <th class="text-center"><?php echo $CI->lang->line('SURVEY_FARMER_TITLE_LAST_YEAR_VEGETABLES_PRODUCTION_COST_IRRIGATION');?></th>
                            <th class="text-center"><?php echo $CI->lang->line('SURVEY_FARMER_TITLE_LAST_YEAR_VEGETABLES_PRODUCTION_COST_FERTILIZERS');?></th>
                            <th class="text-center"><?php echo $CI->lang->line('SURVEY_FARMER_TITLE_LAST_YEAR_VEGETABLES_PRODUCTION_COST_PESTICIDE');?></th>
                            <th class="text-center"><?php echo $CI->lang->line('SURVEY_FARMER_TITLE_LAST_YEAR_VEGETABLES_PRODUCTION_COST_OTHERS');?></th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php
                ...
                <table class="table table-bordered table-responsive ">
                    <tbody>
                    <tr>
                        <th style="width: 30%"><?php echo $CI->lang->line('SURVEY_FARMER_TITLE_HAVE_VEGETABLES_TRAINING');?></th>
                        <th style="width: 70%">
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="have_vegetables_training"><?php echo $CI->lang->line('SURVEY_FARMER_YES');?></label>
                            </div>
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="have_vegetables_training"><?php echo $CI->lang->line('SURVEY_FARMER_NO');?></label>
                            </div>
                            <hr/>
                            <div class="col-md-4">
                                <label for="need_technical_training_media"><?php echo $CI->lang->line('SURVEY_FARMER_HAVE_VEGETABLES_TRAINING_MEDIA');?></label>
                            ...
                            <div class="col-md-4">
                                <label for="need_technical_training_institute"><?php echo $CI->lang->line('SURVEY_FARMER_HAVE_VEGETABLES_TRAINING_INSTITUTE');?></label>
                            ...
                            <div class="col-md-4">
                                <label for="need_technical_training_subject"><?php echo $CI->lang->line('SURVEY_FARMER_HAVE_VEGETABLES_TRAINING_SUBJECT');?></label>
                    ...
                    <tr>
                        ...
                        <th>
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="need_technical_knowledge_cultivation"><?php echo $CI->lang->line('SURVEY_FARMER_YES');?></label>
                            </div>
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="need_technical_knowledge_cultivation">
                                    <?php echo $CI->lang->line('SURVEY_FARMER_NO');?>
                                    <!--<input type="text" class=" form-inline" id="crop_type_preference" name="item[crop_type_preference]" value="<?php /*echo $item['crop_type_preference']*/?>" placeholder="<?php /*echo $CI->lang->line('SURVEY_FARMER_NO_PLACEHOLDER');*/?>"  style="width: 250px;"/>-->
                                </label>
                            </div>
                        </th>
                    </tr>
                    <tr>
                        ...
                        <th>
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="technical_knowledge_vegetables_cultivation"><?php echo $CI->lang->line('SURVEY_FARMER_TECHNICAL_KNOWLEDGE_VEGETABLES_CULTIVATION');?></label>
                            </div>
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="technical_knowledge_quality_seeds"> <?php echo $CI->lang->line('SURVEY_FARMER_TECHNICAL_KNOWLEDGE_QUALITY_SEEDS');?></label>
                            </div>
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="technical_knowledge_pest_management"><?php echo $CI->lang->line('SURVEY_FARMER_TECHNICAL_KNOWLEDGE_PEST_MANAGEMENT');?></label>
                            </div>
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="technical_knowledge_others">
                                    <?php echo $CI->lang->line('SURVEY_FARMER_OTHERS');?>
                                    <input type="text" class=" form-inline" id="technical_knowledge_others_remarks" name="item[technical_knowledge_others_remarks]" value="<?php echo $item['technical_knowledge_others_remarks']?>" placeholder="<?php echo $CI->lang->line('SURVEY_FARMER_OTHERS_PLACEHOLDER');?>"  style="width: 250px;"/>
                                </label>
                            </div>
                        </th>
                    </tr>
                    <tr>
                        ...
                        <th>
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="seeds_collect_dealers"><?php echo $CI->lang->line('SURVEY_FARMER_SEEDS_COLLECT_DEALERS');?> </label>
                            </div>
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="seeds_collect_retailers"> <?php echo $CI->lang->line('SURVEY_FARMER_SEEDS_COLLECT_RETAILERS');?> </label>
                            </div>
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="seeds_collect_leadfarmers"><?php echo $CI->lang->line('SURVEY_FARMER_SEEDS_COLLECT_LEADFARMERS');?></label>
                            </div>
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="seeds_collect_hatbazar"><?php echo $CI->lang->line('SURVEY_FARMER_SEEDS_COLLECT_HATBAZAR');?></label>
                            </div>
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="seeds_collect_ownseeds"><?php echo $CI->lang->line('SURVEY_FARMER_SEEDS_COLLECT_OWNSEEDS');?></label>
                            </div>
                            <div class="form-check form-check-inline">
                    ...
                    <tr>
                        ...
                        <th>
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="ensure_seed_quality_germination"><?php echo $CI->lang->line('SURVEY_FARMER_ENSURE_SEED_QUALITY_GERMINATION');?></label>
                            </div>
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="ensure_seed_quality_faith"><?php echo $CI->lang->line('SURVEY_FARMER_ENSURE_SEED_QUALITY_FAITH');?></label>
                            </div>
                            <div class="form-check form-check-inline">
                    ...
                    <tr>
                        ...
                        <th>
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="good_seed_purchase"><?php echo $CI->lang->line('SURVEY_FARMER_YES');?></label>
                            </div>
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="good_seed_purchase">
                                    <?php echo $CI->lang->line('SURVEY_FARMER_NO');?>
                                    <input type="text" class=" form-inline" id="good_seed_purchase_remarks" name="item[good_seed_purchase_remarks]" value="<?php echo $item['good_seed_purchase_remarks']?>" placeholder="<?php echo $CI->lang->line('SURVEY_FARMER_NO_PLACEHOLDER');?>"  style="width: 250px;"/>
                                </label>
                            </div>
                        </th>
                    </tr>
                    <tr>
                        ...
                        <th>
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="sell_vegetables_to_artodar_paikar"> <?php echo $CI->lang->line('SURVEY_FARMER_SELL_VEGETABLES_TO_ARTODAR_PAIKAR');?></label>
                            </div>
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="sell_vegetables_to_hatbazar"><?php echo $CI->lang->line('SURVEY_FARMER_SELL_VEGETABLES_TO_HATBAZAR');?></label>
                            </div>
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="sell_vegetables_in_group"><?php echo $CI->lang->line('SURVEY_FARMER_SELL_VEGETABLES_IN_GROUP');?></label>
                            </div>
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="sell_vegetables_others">
                                    <?php echo $CI->lang->line('SURVEY_FARMER_OTHERS');?>
                                    <input type="text" class=" form-inline" id="sell_vegetables_others_remarks" name="item[sell_vegetables_others_remarks]" value="<?php echo $item['sell_vegetables_others_remarks']?>" placeholder="<?php echo $CI->lang->line('SURVEY_FARMER_OTHERS_PLACEHOLDER');?>"  style="width: 250px;"/>
                                </label>
                            </div>
                        </th>
                    </tr>
                        ...
                        <th>
                            <div class="form-check form-check-inline">
                                <div class="form-check form-check-inline">
                                    ...
                                    <label class="form-check-label" for="does_artodar_paikar_helps1"><?php echo $CI->lang->line('SURVEY_FARMER_YES');?></label>
                                </div>
                                <div class="form-check form-check-inline">
                                    ...
                                    <label class="form-check-label" for="does_artodar_paikar_helps"><?php echo $CI->lang->line('SURVEY_FARMER_NO');?></label>
                                </div>
                            </div>
                        </th>
                    </tr>
                    <tr>
                        <th>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <?php echo $CI->lang->line('SURVEY_FARMER_TITLE_DOES_ARTODAR_PAIKAR_HELPS');?>
                        </th>
                        <th>
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="does_artodar_paikar_helps_supplying_seeds"><?php echo $CI->lang->line('SURVEY_FARMER_DOES_ARTODAR_PAIKAR_HELPS_SUPPLYING_SEEDS');?></label>
                            </div>
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="does_artodar_paikar_helps_credit_facilities"><?php echo $CI->lang->line('SURVEY_FARMER_DOES_DOES_ARTODAR_PAIKAR_HELPS_CREDIT_FACILITIES');?></label>
                            </div>
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="does_artodar_paikar_helps_others">
                                    <?php echo $CI->lang->line('SURVEY_FARMER_OTHERS');?>
                                    <input type="text" class=" form-inline" id="does_artodar_paikar_helps_remarks" name="item[does_artodar_paikar_helps_remarks]" value="<?php echo $item['does_artodar_paikar_helps_remarks']?>" placeholder="<?php echo $CI->lang->line('SURVEY_FARMER_OTHERS_PLACEHOLDER');?>"  style="width: 250px;"/>
                                </label>
                            </div>
                        </th>
                    </tr>
                    <tr>
                        ...
                        <th>
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="seed_facilities"><?php echo $CI->lang->line('SURVEY_FARMER_YES');?></label>
                            </div>
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="seed_facilities">
                                    <?php echo $CI->lang->line('SURVEY_FARMER_NO');?>
                                    <input type="text" class=" form-inline" id="seed_facilities_remarks" name="item[seed_facilities_remarks]" value="<?php echo $item['seed_facilities_remarks']?>" placeholder="<?php echo $CI->lang->line('SURVEY_FARMER_NO_PLACEHOLDER');?>"  style="width: 250px;"/>
                                </label>
                            </div>
                        </th>
                    </tr>
                        ...
                        <th>
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="do_know_arm1">
                                    <?php echo $CI->lang->line('SURVEY_FARMER_YES');?>
                                    <input type="text" class=" form-inline" id="do_know_arm_remarks" name="item[do_know_arm_remarks]" value="<?php echo $item['do_know_arm_remarks']?>" placeholder="<?php echo $CI->lang->line('SURVEY_FARMER_DO_KNOW_ARM_REMARKS');?>"  style="width: 250px;"/>
                                </label>
                            </div>
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="do_know_arm"><?php echo $CI->lang->line('SURVEY_FARMER_NO');?></label>
                            </div>
                        </th>
                    </tr>
                    <tr>
                        <th colspan="2">
                            <div class="col-md-12">
                                <label for="remarks"><?php echo $CI->lang->line('SURVEY_FARMER_TITLE_REMARKS');?></label>

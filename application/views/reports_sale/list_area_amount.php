        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                rowsheight: 40,
                columns: [
                    { text: '<?php echo $areas; ?>', dataField: 'area',pinned:true,width:'200',cellsrenderer: cellsrenderer,hidden: <?php echo $system_preference_items['area']?0:1;?>,aggregates: [{ 'total':aggregates}],aggregatesrenderer:aggregatesrenderer},

...
$action_buttons[]=array(
    ...
    'href'=>site_url($CI->controller_url.'/index/lead_farmer_list/'.$item_head['area_id'])
);
$action_buttons[]=array(
    'type'=>'button',
...
<form id="save_form" action="<?php echo site_url($CI->controller_url.'/index/save');?>" method="post">
    ...
    <div class="row widget">
        ...
        <div class="row show-grid">
            ...
            <div class="col-sm-4 col-xs-8">
                <input type="text" name="item[mobile_no]" id="price" class="form-control float_type_positive" value="<?php echo $item['mobile_no'];?>"/>
            </div>
        </div>

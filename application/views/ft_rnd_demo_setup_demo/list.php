        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_CROP_TYPE_NAME'); ?>',pinned:true,dataField: 'crop_type_name',width:'100',rendered:tooltiprenderer,hidden: <?php echo $system_preference_items['crop_type_name']?0:1;?>},
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_SEASON'); ?>',pinned:true,dataField: 'season',filtertype: 'list',width:'80',rendered:tooltiprenderer,hidden: <?php echo $system_preference_items['season']?0:1;?>},
                    { text: '<?php echo $CI->lang->line('LABEL_YEAR'); ?>',pinned:true,dataField: 'year',filtertype: 'list',width:'80',rendered:tooltiprenderer,hidden: <?php echo $system_preference_items['year']?0:1;?>},
                    { text: '<?php echo $CI->lang->line('LABEL_PRI_NAME'); ?>',dataField: 'pri_name',width:'210',rendered:tooltiprenderer,hidden: <?php echo $system_preference_items['pri_name']?0:1;?>},

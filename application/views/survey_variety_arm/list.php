        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns:[
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_CHARACTERISTICS'); ?>',dataField: 'characteristics',width:'100',filtertype: 'list',rendered:tooltiprenderer,hidden: <?php echo $system_preference_items['characteristics']?0:1;?>},
                    { text: '<?php echo $CI->lang->line('LABEL_NUMBER_OF_IMAGES'); ?>',dataField: 'number_of_images',width:'130',cellsalign: 'right',rendered:tooltiprenderer,hidden: <?php echo $system_preference_items['number_of_images']?0:1;?>},
                    { text: '<?php echo $CI->lang->line('LABEL_NUMBER_OF_VIDEOS'); ?>',dataField: 'number_of_videos',width:'130',cellsalign: 'right',rendered:tooltiprenderer,hidden: <?php echo $system_preference_items['number_of_videos']?0:1;?>}
                ]
            });
    });
</script>

        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_STATUS_REPORTING_APPROVE'); ?>', dataField: 'status_reporting_approve', width: '120', rendered: tooltiprenderer, filtertype: 'list', hidden: <?php echo $system_preference_items['status_reporting_approve']?0:1;?>}
                ]
            });
    });
</script>

...
<form class="form_valid" id="save_form" action="<?php echo site_url($CI->controller_url . '/index/save_forward'); ?>" method="post">
    ...
    <div class="row show-grid">
        ...
        <div class="col-sm-4 col-xs-8">
            <select name="item[status_recommendation]" class="form-control status-combo">
                ...
                <option value="<?php echo $CI->config->item('system_status_rejected'); ?>"><?php echo $CI->lang->line('LABEL_REJECT'); ?></option>
            </select>
        </div>
    </div>
    ...
    <div class="row show-grid">
        ...
        <div class="col-sm-4 col-xs-8">
            <textarea name="item[remarks_recommendation]" class="form-control"></textarea>
        </div>
    </div>
...
<script type="text/javascript">
    jQuery(document).ready(function ($) {
        ...
        $(".status-combo").on('change', function (event) {
            ...
            else if (options == '<?php echo $CI->config->item('system_status_pending'); ?>') {

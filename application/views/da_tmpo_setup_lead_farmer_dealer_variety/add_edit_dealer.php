...
$action_buttons[]=array(
    ...
    'href'=>site_url($CI->controller_url.'/index/list_dealer/'.$item_head['area_id'])
);
$action_buttons[]=array(
    'type'=>'button',
...
?>
<form id="save_form" action="<?php echo site_url($CI->controller_url.'/index/save_dealer');?>" method="post">

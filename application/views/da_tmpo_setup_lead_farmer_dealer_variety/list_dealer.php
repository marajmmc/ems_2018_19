...
if(isset($CI->permissions['action1']) && ($CI->permissions['action1']==1))
{
    $action_buttons[]=array(
        ...
        'href'=>site_url($CI->controller_url.'/index/add_edit_dealer/'.$item['id'])
    );
}
if(isset($CI->permissions['action2']) && ($CI->permissions['action2']==1))
{
    $action_buttons[]=array(
        ...
        'data-action-link'=>site_url($CI->controller_url.'/index/add_edit_dealer/'.$item['id'])
    );
}
...
$action_buttons[]=array(
    ...
    'href'=>site_url($CI->controller_url.'/index/list_dealer/'.$item['id'])
);
...
<script type="text/javascript">
    $(document).ready(function ()
    {
        ...
        var url = "<?php echo site_url($CI->controller_url.'/index/get_dealers');?>";
        // prepare the data
        var source =
        {
            dataType: "json",
        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_DEALER_NAME'); ?>', dataField: 'dealer_name', width:'250',rendered:tooltiprenderer},

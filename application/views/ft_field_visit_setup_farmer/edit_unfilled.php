...
<form class="form_valid" id="save_form" action="<?php echo site_url($CI->controller_url.'/index/save_unfilled');?>" method="post">
    ...
    <div class="row widget">
        ...
        <div class="row show-grid">
            ...
            <div class="col-sm-4 col-xs-8">
                <input type="text" name="item[contact_no]" class="form-control" value="<?php echo $item['contact_no']; ?>">
            </div>
        </div>
        <div class="row show-grid">
            <div class="col-xs-4">
        ...
        <div class="row show-grid">
            ...
            <div class="col-sm-4 col-xs-8">
                <input type="text" name="item[date_transplant]" class="form-control datepicker" value="<?php if($item['date_transplant']>0){echo System_helper::display_date($item['date_transplant']); }?>">
            </div>
        </div>
        <div class="row show-grid">
            <div class="col-xs-4">

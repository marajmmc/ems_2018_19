        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_STATUS_COMPLETE'); ?>', dataField: 'status_complete',filtertype: 'list',width:'50',rendered:tooltiprenderer,hidden: <?php echo $system_preference_items['status_complete']?0:1;?>}
                ]
            });
    });
</script>

...
if((isset($CI->permissions['action1']) && ($CI->permissions['action1']==1)) || (isset($CI->permissions['action2']) && ($CI->permissions['action2']==1)))
{
    ...
    (
        ...
        'data-action-link'=>site_url($CI->controller_url.'/index/add_edit/'.$options['date_editable'])
    );
}
        ...
        <div class="row show-grid">
            <div class="col-xs-12">
                ...
                <div class="col-sm-1 col-xs-1">
                    <input type="text" name="report[date_editable]" id="date_editable" class="form-control datepicker" value="<?php echo System_helper::display_date($options['date_editable']);?>" readonly />
                </div>
            </div>
        </div>
        <hr/>
...
<script type="text/javascript">
    $(document).ready(function ()
    {
        ...
        $(".datepicker").on('change', function(){
            var url_list="<?php echo site_url($CI->controller_url.'/index/list/');?>"+$('#date_editable').val();
            $.ajax({
                url: url_list,
                type: 'POST',
                dataType: "JSON",

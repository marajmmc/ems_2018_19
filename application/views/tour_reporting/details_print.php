                ...
                <div class="col-xs-12">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td><?php if($item['designation']){echo $item['designation'];}else{echo 'N/A';}?></td>

                        </tr>
                        <tr>
                            <td style="width: 10%"><strong><?php echo $CI->lang->line('LABEL_DATE');?></strong></td>
                            <td>From: <?php echo System_helper::display_date($item['date_from'])?> To: <?php echo System_helper::display_date($item['date_to'])?></td>
                            <td style="width: 10%"><strong>Department</strong></td>
                            <td><?php if($item['department_name']){echo $item['department_name'];}else{echo 'N/A';}?></td>
                ...
                <div class="col-xs-12">
                    ...
                    if($items_purpose_others)
                    {
                        ...
                        foreach($items_purpose_others as $items_purpose_other)
                        {
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                <tr>
                                    <td colspan="21"><strong><?php echo $serial;?>. Purpose:: <?php echo $items_purpose_other['purpose'];?> </strong></td>
                                </tr>
                                <tr>
                            ...
                            if($items_purpose_other['purpose_others_id'])
                            {
                                ...
                                <tr>
                                    <td style="height: 10px;">Name</td>
                                    <td style="height: 10px;">Contact No</td>
                                    <td style="height: 10px;">Profession</td>
                                    <td style="height: 10px;">Discussion</td>
                                </tr>
                                <?php
                    ...
                    <table class="table table-bordered">
                        <tbody>
                            ...
                            <tr>
                                <td style="width: 15%"><?php if($item['remarks']){echo $item['remarks'];}else{echo 'N/A';}?></td>
                                <td style="width: 15%"><?php if($item['superior_comment']){echo $item['superior_comment'];}else{echo 'N/A';}?></td>
                            </tr>
                        </tbody>
                    </table>
                    <?php } ?>

        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: 'Forward Status', dataField: 'status_forwarded_tour', filtertype: 'list', width: '160', rendered: tooltiprenderer, hidden: <?php echo $system_preference_items['status_forwarded_tour']?0:1;?>},
                    { text: 'Approve Status', dataField: 'status_approved_tour', filtertype: 'list', width: '160', rendered: tooltiprenderer, hidden: <?php echo $system_preference_items['status_approved_tour']?0:1;?>}
                ]
            });
    });
</script>
...
<div class="row widget">
    ...
    <div class="row show-grid">
        ...
        <div class="col-sm-4 col-xs-8">
            <label class="control-label"><?php echo ($item['remarks']) ? nl2br($item['remarks']) : "N/A"; ?></label>
        </div>
    </div>
</div>
<form class="form_valid" id="save_form" action="<?php echo site_url($CI->controller_url . '/index/save_forward'); ?>"
      method="post">

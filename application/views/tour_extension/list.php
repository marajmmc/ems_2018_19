        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: 'Title', dataField: 'title', width: '220', hidden: <?php echo $system_preference_items['title']?0:1;?>},
                    ...
                    { text: 'IOU Extension Status', dataField: 'status_extended_tour',filtertype: 'list',width:'160',rendered:tooltiprenderer, hidden: <?php echo $system_preference_items['status_extended_tour']?0:1;?>},

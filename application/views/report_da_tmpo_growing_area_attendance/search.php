...
$start_date=System_helper::get_time(date('Y-m-01', strtotime("-1 month")));
$end_date=System_helper::get_time(date('Y-m-t', strtotime("-1 month")));
?>
    ...
    <div class="row widget">
        ...
        <div class="row show-grid">
            ...
            <div class="row show-grid">
                ...
                <div class="col-sm-4 col-xs-8">
                    <input type="text" id="date_start" name="report[date_start]" class="form-control date_large" value="<?php echo System_helper::display_date($start_date); ?>">
                </div>
            </div>
            <div class="row show-grid">
                <div class="col-xs-4">
                ...
                <div class="col-sm-4 col-xs-8">
                    <input type="text" id="date_end" name="report[date_end]" class="form-control date_large" value="<?php echo System_helper::display_date($end_date); ?>">
                </div>
            </div>
            <!--<div class="row show-grid">
                <div class="col-xs-4">

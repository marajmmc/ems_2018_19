...
<div class="row widget">
            ...
            <table style="width:100%">
                ...
                foreach ($dealers as $dealer)
                {
                    ...
                    <tr>
                        ...
                        <td style="text-align:right"><?php echo $old_reporting['reporting_participants_dealer'][$dealer['dealer_id']]; ?></td>
                    </tr>
                    <?php
                    ...
                    $reporting_sub_total_participant += $old_reporting['reporting_participants_dealer'][$dealer['dealer_id']];
                }
                ?>
                <tr>
            ...
            <table style="width:100%">
                ...
                foreach ($lead_farmers as $farmer)
                {
                    ...
                    <tr>
                        ...
                        <td style="text-align:right"><?php echo $old_reporting['reporting_participants_farmer'][$farmer['lead_farmers_id']]; ?></td>
                    </tr>
                    <?php
                    ...
                    $reporting_sub_total_participant += $old_reporting['reporting_participants_farmer'][$farmer['lead_farmers_id']];
                }
                ?>
                <tr>
                    <td style="border-top:1px solid #CFCFCF; text-align:right; font-weight:bold" colspan="2">Sub Total :</td>
                ...
                <tr>
                    ...
                    <td style="text-align:right"><?php echo $old_reporting['reporting_participant_others']; ?></td>
                    <?php $reporting_total_participant += $old_reporting['reporting_participant_others']; ?>
                </tr>
                <tr>
            ...
            <table style="width:100%">
                ...
                foreach ($expense_items as $expense)
                {
                    ...
                    <tr>
                        ...
                        <td style="text-align:right"><?php echo System_helper::get_string_amount($old_reporting['reporting_amount_expense_items'][$expense['id']]); ?></td>
                    </tr>
                    <?php
                    $total_budget += $expense['amount'];
                    $total_actual_budget += $old_reporting['reporting_amount_expense_items'][$expense['id']];
                }
                ?>
                <tr>
        ...
        <div class="col-xs-8">
            <table style="width:100%">
                ...
                <tr>
                    ...
                    <td style="text-align:right"><?php echo System_helper::get_string_kg($old_reporting['reporting_quantity_market_size_showroom_total']); ?></td>
                </tr>
                <tr>
                    ...
                    <td style="text-align:right"><?php echo System_helper::get_string_kg($old_reporting['reporting_quantity_market_size_ga_total']); ?></td>
                </tr>
                <tr>
                    ...
                    <td style="text-align:right"><?php echo System_helper::get_string_kg($old_reporting['reporting_quantity_market_size_showroom_arm']); ?></td>
                </tr>
                <tr>
                    ...
                    <td style="text-align:right"><?php echo System_helper::get_string_kg($old_reporting['reporting_quantity_market_size_ga_arm']); ?></td>
                </tr>
                <tr>
                    ...
                    <td style="text-align:right"><?php echo System_helper::get_string_kg($old_reporting['reporting_quantity_sales_target']); ?></td>
                </tr>
            </table>
        </div>
    </div>
    ...
    <form class="form_valid" id="save_form" action="<?php echo site_url($CI->controller_url . '/index/save_forward'); ?>" method="post">
        ...
        <div class="row show-grid">
            ...
            <div class="col-xs-4">
                <select name="item[status_reporting_forward]" class="form-control status-combo">
        ...
        <div class="row show-grid">
            ...
            <div class="col-xs-4">
                <textarea name="item[remarks_reporting_forward]" class="form-control"></textarea>
            </div>
        </div>

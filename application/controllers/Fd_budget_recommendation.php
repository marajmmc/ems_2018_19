...
class Fd_budget_recommendation extends Root_Controller
{
    ...
    private function get_preference_headers($method)
    {
        ...
        if ($method == 'list_all')
        {
            $data['status_forwarded_recommendation'] = 1;
        }
        return $data;
    }
    ...
    private function system_get_items()
    {
        ...
        $this->db->where('fd_budget.status_forwarded_recommendation !=', $this->config->item('system_status_forwarded'));
...
//    }
    ...
    private function system_edit($id)
    {
        if (isset($this->permissions['action2']) && ($this->permissions['action2'] == 1))
        {
            ...
            if ($result['status_budget'] == $this->config->item('status_forwarded_recommendation'))
            {
                $ajax['status'] = false;
...
//        $this->form_validation->set_rules('item_info[remarks_budget]', $this->lang->line('LABEL_RECOMMENDATION'), 'required');
